...
c.styleSheet?c.styleSheet.cssText=b:c.appendChild(window.document.createTextNode(String(b)));$.Xe($.De(window.document,"head",void 0,void 0)[0],c,0);NE=!0}this.Sd||(this.Sd=$.Oe("DIV","anychart-credits"));this.i||(this.i=$.Oe("A"),this.D=$.Oe("SPAN","anychart-credits-text"),this.b=$.Oe("SVF","anychart-credits-logo"),Ve(this.i,this.D),this.Sd.appendChild(this.i));b=this.f.Pl();this.J(ml)&&(b&&b.appendChild(this.Sd),this.I(ml));this.J(nl)&&(b=$.ic.apply(null,[", v%s.%s.%s.%s"].concat(["8","11","0",
"1934"])),c=a?this.nK():"AnyChart - JavaScript Charts designed to be embedded and integrated{{anychart-version}}",$.Fe(this.i,{href:a?this.pK():"https://www.anychart.com/?utm_source=trial",title:c.replace("{{anychart-version}}",b),target:"_blank"}),$.Fe(this.b,{alt:a?this.oK():"AnyChart - JavaScript Charts"}),this.I(nl));this.J(ol)&&(a=a?this.text():"",$.ef(this.D,a),this.I(ol));if(this.J(pl)){if(a=tl(this)?this.wF():rl()){if(this.P=a,b=vh($.ng()))$.Ld(b,"complete",this.l4,!1,
